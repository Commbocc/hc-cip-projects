...
/* harmony default export */ var Searchvue_type_script_lang_js_ = ({
  ...
  methods: _objectSpread({}, mapActions(['fetchProjects']), mapMutations(['toggleSearchDrawer', 'resetSearch', 'resetFilters']), {
...
var Project_component = normalizeComponent(
  ...
  Projectvue_type_template_id_03c60e14_lang_html_render,
  Projectvue_type_template_id_03c60e14_lang_html_staticRenderFns,
  false,
  null,
  null,
  null
...
function () {
  ...
  _createClass(Project, [{
    ...
    value: function currency(field) {
      var fixed = this[field].toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
      return "$".concat(fixed);
    }
  }, {
    key: "path",
  ...
  actions: {
    fetchProjects: function fetchProjects(_ref) {
      ...
      getters.projectsFeatureLayer.then(function (fl) {
        promise_default.a.all([fl.queryFeatures(getters.queryParams), fl.queryFeatureCount(getters.queryParams)]).then(function (response) {
...
/* harmony default export */ var filters = ({
  ...
  getters: {
    filterClause: function filterClause(state) {
      var expressions = keys_default()(state.fields).map(function (k) {
